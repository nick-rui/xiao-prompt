          ...
          <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
              {metrics.map((metric) => (
                <Card
                  key={metric.label}
                  className={`glass-effect ${metric.borderColor} hover:scale-105 transition-transform duration-200 min-w-[200px]`}
                >
                  <CardContent className="pt-6 pb-6 px-6">
                    <div className="flex flex-col items-center text-center space-y-4">
                      ...
                      <div className="w-full">
                        <div className={`text-3xl font-bold font-mono ${metric.color} mb-2 break-words`}>{metric.value}</div>
